...
import VerseBank from '../components/VerseBank.vue'

const navigation = [
  { name: 'Dashboard', href: '#', icon: HomeIcon, current: false },
  { name: 'Verse Bank', href: '#', icon: UsersIcon, current: true },
  { name: 'Memorized Verses ', href: '#', icon: FolderIcon, current: false }
]
